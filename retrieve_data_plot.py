...
with h5py.File(".\\data\\"+spa.datelabel+"_testrun\\Act_Rac.h5",'r') as f:
    for i in range(0,spa.rounds,spa.sampot):
        ...
        plt.savefig(".\\result\\"+spa.datelabel+"_testrun\\Act_rac_" + str(i) + ".jpg")
        plt.clf()
with h5py.File(".\\data\\"+spa.datelabel+"_testrun\\Inact_Rac.h5",'r') as f:
    for i in range(0,spa.rounds,spa.sampot):
